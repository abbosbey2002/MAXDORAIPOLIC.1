  ...
  const addDrivers = () => {
    const req = async () => {
      ...
      if (req.req) {
        setDriver(req);
        setIsFamily(true);
        document.getElementById("driverPassportSeria").style.borderColor =
          "#dee2e6";
        document.getElementById("driverPassportNumber").style.borderColor =
          "#dee2e6";
        document.getElementById("driverBirthdate").style.borderColor =
          "#dee2e6";
      } else {
        document.getElementById("driverPassportSeria").style.borderColor =
          "red";
...
useEffect(() => {
  ...
  return (
    <>
      <div id="policyCalculate" style={{ display: "block" }}>
        {/*--- ========== title ========== ---*/}
        <div className="row">
          ...
          <div className="row rounded border p-3 my-3">
            ...
            <div className="col-sm-12 col-lg-6 mb-3">
              ...
              >
                <option selected value={1}>На 1 год</option>
            ...
            <div className="row">
              <div className="col-sm-12 col-lg-4 my-3">
                <button
                  type="hidden"
                  id="modal4_btn"
                  className="btn btn-dark modal-trigger"
      ...
      <div
        className={`clientModal row justify-center absolute w-full ${
          active ? "active" : ""
        }`}
      >
        <div className="col-sm-12 col-lg-6 m-8 bg-white rounded">
          <section className="rounded" id="modal4" style={{ display: "block" }}>
            <section className="osago__cart__osago3">
              <div className="row p-5">
                ...
                <div className="col-sm-12 col-lg-4 mb-3">
                  <button onClick={addDrivers} className="btn btn-danger mt-8">
                    Далее
                    <span>
                      <i className="fas fa-long-arrow-alt-right" />
                    </span>
                ...
                {isFamily && (
                  <div className="col-sm-12 col-lg-8 mb-3">
                    ...
                    <select
                      required=""
                      aria-label=""
                      className="form-select modaLcountry"
                      name="relative"
                      id="relative"
                      onChange={(e) => setFamily(e.target.value)}
                    >
                      <option id="not_relative_option" value={0}>
                        Не родственник
                      </option>
                ...
                {isFamily && (
                  <div class="col-sm-12 col-lg-4">
                    <button onClick={saveDriver} class="btn btn-danger">
                      Сохранить
                    </button>
                  </div>
                )}
